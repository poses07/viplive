<?php
// leave_room.php - Record user leaving a room
...
$sql = "DELETE FROM room_audience WHERE room_id = $room_id AND user_id = $user_id";
...
if ($conn->query($sql) === TRUE) {
    ...
    echo json_encode(["error" => "Error leaving room: " . $conn->error]);
}
